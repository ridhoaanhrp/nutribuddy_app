...
import 'package:nutribuddy_app/Screens/splash_screen_3.dart';
import 'package:page_transition/page_transition.dart';

class FormDataFemale extends StatefulWidget {
  const FormDataFemale({Key? key}) : super(key: key);

  @override
  _FormDataFemaleState createState() => _FormDataFemaleState();
}

class _FormDataFemaleState extends State<FormDataFemale> {
  ...
  TextEditingController sedangmengandungController = TextEditingController();
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              height: 55,
              child: TextFormField(
                  controller: sedangmengandungController,
                  obscureText: true,
                  validator: (value) {
                    return value!.isEmpty ? "isi form dibawah ini!" : null;
                  },
                  decoration: InputDecoration(
                    labelText: "Sedang Mengandung?",
                    labelStyle:
                        const TextStyle(fontSize: 13, color: Color(0xff44B4FF)),
